            ...
            <div className="max-w-3xl w-full bg-white rounded-3xl shadow-xl overflow-hidden border border-gray-100">
                ...
                <div className="bg-gray-50 border-b border-gray-200 p-8 text-center relative overflow-hidden">
                    <div className="relative z-10 flex flex-col items-center">
                        <div className="bg-primary/10 border border-primary/30 px-4 py-4 rounded-full mb-4 animate-in zoom-in duration-500 delay-150">
                            <CheckCircle size={64} className="text-primary" />
                        </div>
                        <h1 className="text-3xl md:text-4xl font-bold text-gray-900 mb-2 tracking-wide font-display">Request Received!</h1>
                        <p className="text-secondary text-lg font-light">Your adventure awaits, {booking.firstName}.</p>
                    </div>
                </div>
                ...
                <div className="p-8 md:p-12">
                    ...
                    {/* Ticket / Summary Card */}
                    <div className="bg-gray-50 border border-gray-200 rounded-2xl p-6 md:p-8 mb-10 relative">
                        <h3 className="text-xs font-bold text-gray-400 uppercase tracking-widest mb-6 font-display">Reservation Summary</h3>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                            <div className="space-y-6">
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        <p className="text-sm text-gray-500 font-light">Dates</p>
                                        <p className="font-bold text-gray-900 font-display">{formatDate(booking.startDate)}</p>
                                        <p className="text-gray-400 text-sm font-light">to</p>
                                        <p className="font-bold text-gray-900 font-display">{formatDate(booking.endDate)}</p>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="font-bold text-gray-900 font-display">Santa Teresa, Costa Rica</p>
                                        <p className="text-sm text-secondary font-light">Free delivery to your hotel</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="space-y-6">
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        <p className="text-sm text-gray-500 font-light">Renter</p>
                                        <p className="font-bold text-gray-900 font-display">{booking.firstName} {booking.lastName}</p>
                                        <p className="text-sm text-gray-500 font-light">{booking.whatsappNumber}</p>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        <p className="text-sm text-gray-500 font-light">Total Estimated</p>
                                        <p className="font-bold text-secondary text-xl font-display">${booking.totalPrice}</p>
                                        <p className="text-xs text-gray-400 font-light">Paid upon delivery</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="flex flex-col items-center gap-4">
                        ...
                        <button
                            onClick={onHome}
                            className="w-full max-w-sm bg-gray-100 border border-gray-200 hover:bg-gray-200 text-gray-700 text-lg font-bold py-4 px-8 rounded-xl shadow-sm hover:shadow-md transition-all transform hover:-translate-y-1 flex items-center justify-center gap-2"
                        >
                            <Home size={20} />
                            Return to Home
                        </button>
                        <p className="text-sm text-gray-400 font-light text-center mt-2">
