    ...
    return (
        <div className="group bg-white rounded-2xl overflow-hidden shadow-xl hover:shadow-2xl transition-all duration-300 border border-stone-100 flex flex-col">
            <div className="relative h-64 overflow-hidden">
                ...
                />
                <div className="absolute top-4 right-4 bg-white/90 backdrop-blur text-emerald-900 font-bold py-1 px-3 rounded-full text-sm shadow-sm">
                    ${atv.dailyPrice} / day
                </div>
            </div>
            
            <div className="p-8 flex-grow flex flex-col">
                <h3 className="text-2xl font-bold text-emerald-950 mb-3">{atv.modelName}</h3>
                ...
                <button 
                    ...
                    className="w-full py-4 rounded-xl bg-stone-100 hover:bg-emerald-900 hover:text-white text-emerald-950 font-bold transition-all flex items-center justify-center gap-2 group-hover:bg-emerald-900 group-hover:text-white"
                >
                    View Details
                    <ArrowRight size={18} />
                </button>
