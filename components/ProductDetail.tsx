                            ...
                            <div className="flex gap-2 mb-8 overflow-x-auto pb-1">
                                {allImages.map((img, i) => (
                                    <button
                                        ...
                                        className={`shrink-0 w-20 h-16 rounded-xl overflow-hidden border-2 transition-all ${activeImage === img ? 'border-primary shadow-[0_4px_12px_-4px_rgba(184,82,26,0.5)]' : 'border-gray-200 hover:border-gray-300'}`}
                                    >
...
<div className="bg-gray-50 p-6 rounded-2xl border border-gray-200 mb-8">
                        ...
                        {isUnavailable ? (
                            ...
                            <button
                                onClick={onBook}
                                className="w-full bg-primary hover:bg-primary-hover text-white text-xl font-bold py-5 rounded-xl shadow-[0_8px_24px_-8px_rgba(184,82,26,0.5)] hover:shadow-[0_12px_30px_-8px_rgba(184,82,26,0.6)] transition-all transform hover:-translate-y-1 hover:scale-[1.02]"
                            >
                                Request Booking
                            </button>
                        )}
